...
public class UIButtonStageStart : UIButtonBase, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public override void InputButtonLeft(PointerEventData eventData)
    {
        ...
        SceneLoader.LoadScene(SceneName.Stage.ToString());
    }
