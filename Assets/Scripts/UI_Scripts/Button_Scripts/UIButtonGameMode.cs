...
public class UIButtonGameMode : UIButtonBase, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler, IScrollHandler
{
    ...
    private Color32[] colorBase
       = { new Color32(255, 0, 0, 255), new Color32(255, 191, 0, 255), new Color32(0, 127, 255, 255), new Color32(191, 0, 255, 255), new Color32(0, 191, 0, 255) };
    ...
    {
        if (!isScroll && CheckButton(nowButton, eventData))
        {
            GameBase.gameMode = nowButton;

            if (nowButton <= (int)GameMode.Defense)
            {
